...
def add_model_config_args(parser):
    ...
    group.add_argument("--base", type=str, nargs="*", default=["./configs/cogvideox_5b.yaml", "./configs/inference.yaml"], help="config for input and saving")
    group.add_argument(
...
def add_sampling_config_args(parser):
    ...
    group.add_argument("--start_index", type=int, default=0)
...
def add_others_config_args(parser):
    ...
    group.add_argument("--flask_port", type=int, default=5000)
